--Criar estrutura para Livrarias
...
INSERT INTO editora(codigo,nome) VALUES (5,'EDITORA SARAIVA');
...
INSERT INTO assunto(codigo, nome) VALUES (5, 'MYSQL');
...
INSERT INTO livro(codigo, nome, preco, data_lancamento, cod_editora, cod_assunto)
VALUES (6,  'MYSQL', TO_NUMBER(65.00), TO_DATE(NULL), 5, 5);
